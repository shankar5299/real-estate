    ...
    try {
        ...
        if (userId && userType) {
            if (userType === "tenant") {
                ...
                whereClause = {
                    property: {
                        manangerCognitoId: String(userId),
                    },
                };
            }
        }
        ...
        const formattedApplication = yield Promise.all(application.map((app) => __awaiter(void 0, void 0, void 0, function* () {
            const leases = yield prisma.lease.findFirst({
                where: {
                    tenant: {
            ...
            return Object.assign(Object.assign({}, app), { property: Object.assign(Object.assign({}, app.property), { address: app.property.location.address }), manager: app.property.manager, lease: leases ? Object.assign(Object.assign({}, leases), { nextPaymentDate: calculateNextPaymentDate(leases.startDate) }) : null });
        })));
...
const createApplication = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        res.status(500).json({ message: `Error create application: ${error.message}` });
    }
});
