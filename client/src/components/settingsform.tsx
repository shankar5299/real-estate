...
export const SettingForm = ({ initialData, onSubmit, userType }: SettingsFormProps) => {
                ...
                <Form {...form}>
                    ...
                    >
                        ...
                        <div className="pt-4 flex justify-between">
                            <Button type="button" onClick={toogleEditMode} className="bg-secondary-600 text-white hover:bg-secondary-700">
