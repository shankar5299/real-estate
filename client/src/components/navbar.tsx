            ...
            <div className="flex justify-between items-center w-full py-3 px-8 bg-primary-700 text-white">
                <div className="flex items-center gap-4 md:gap-6">
                    ...
                    {isDashboardPage && authUser && (
                        <Button
                            variant="secondary"
                            className=" md:ml-4 text-primary-700 bg-primary-50 hover:bg-secondary-700 hover:text-primary-50"
                ...
                <div className="flex items-center gap-5">
                    {authUser ? (
                        ...
                        <>
                            <Link href="/sign-in">
                                <Button variant="outline" className=" text-white border-white bg-transparent hover:text-primary-700 rounded-lg">
                                    Sign In
                                </Button>
                            </Link>
                            <Link href="/sign-up">
