...
import { useGetPaymentQuery, useGetPropertyLeasesQuery, useGetPropertyQuery } from "@/state/api"
...
const PropertyTenants = () => {
    ...
    const { data: payments, isLoading: paymentLoading } = useGetPaymentQuery(propertyId);
    if (propertyLoading || leasesLoading || paymentLoading) return <LoadingPage />;
