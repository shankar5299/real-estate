...
import { useGetApplicationQuery, useGetAuthUserQuery, useUpdateApplicationStatusMutation } from '@/state/api'
...
const ApplicationPage = () => {
  ...
  const filteredApplications = application?.filter((application) => {
